...
from repomind.ingestion.ingest.metadata_helper import (
    MetadataFlags,
    MetadataHelper,
    MetadataNode,
)
from repomind.core.di import get_global_injector
from repomind.events.models import SourceBlock, ThinkingBlock
from repomind.core.settings.settings import settings

if TYPE_CHECKING:
    from repomind.rag.chunk.models import SourceType
    from repomind.rag.engines.citations.term_extractor import (
