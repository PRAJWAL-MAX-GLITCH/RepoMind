...
from repomind.core.settings.settings_loader import load_active_settings
...
class ServerSettings(BaseModel):
    ...
    host: str = Field(
        default="0.0.0.0",
        description="Host of RepoMind FastAPI server, defaults to 0.0.0.0",
    )
    port: int = Field(description="Port of RepoMind FastAPI server, defaults to 8080")
...
class DatabaseSettings(BaseModel):
    ...
    local_path: str = Field(
        default="local_data/repomind/skills",
