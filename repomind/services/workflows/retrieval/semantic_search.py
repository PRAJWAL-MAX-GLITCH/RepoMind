...
from repomind.services.workflows.others.condenser import (
    CondenseResultEvent,
    CondenserWorkflow,
)
from repomind.services.workflows.retrieval.retrieval import (
    RetrieverResultEvent,
    RetrieverWorkflow,
)
from repomind.services.workflows.types import AnyContext
...
class SemanticSearchWorkflow(Workflow):
    ...
    async def condense(
        ...
        from repomind.services.workflows.others.condenser import CondenseInputEvent
