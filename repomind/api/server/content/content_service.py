...
from repomind.artifact_index.vector_artifact_index import VectorArtifactIndex
from repomind.chat.extensions.context_filter import ContextFilter
...
from repomind.models.llm.llm_helper import TokenizerFn, get_tokenizer
from repomind.vector_store.node_store.node_store_component import NodeStoreComponent
from repomind.rag.postprocessor.tree_expansion.split_subtrees import (
    SplitSubtreeAlg,
)
from repomind.parsers.readers.nodes import NodeType
from repomind.parsers.readers.nodes.tree_node import TreeMetadataMode, TreeNode
...
class ContentService:
    ...
    async def _format_nodes(
        ...
        from repomind.events.models import SourceBlock, TextBlock
    ...
    async def retrieve_chunked_document_content(
        ...
        async def _format_nodes(tree_nodes: list[BaseNode]) -> list[Any]:
            ...
            from repomind.rag.engines.citations.utils import (
                exclude_metadata,
