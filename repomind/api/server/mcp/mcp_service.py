...
if TYPE_CHECKING:
    from repomind.api.server.mcp._runtime import (
        AudioContent,
        CallToolResult,
        ImageContent,
        PersistentMCPClient,
...
def _load_content_types() -> tuple[
    ...
    from repomind.api.server.mcp._runtime import AudioContent, ImageContent, TextContent

    return TextContent, ImageContent, AudioContent


def _load_call_tool_result_type() -> type["CallToolResult"]:
    from repomind.api.server.mcp._runtime import CallToolResult
