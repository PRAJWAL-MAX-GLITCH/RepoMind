...
from repomind.components.tools.types import ToolValidationMode
from repomind.events.models import (
    FatalError,
    Message,
)
from repomind.api.server.chat.chat_models import ChatBody
from repomind.api.server.chat.chat_request_mapper import ChatRequestMapper
from repomind.api.server.chat.chat_service import ChatService, ChatValidationResult
from repomind.api.server.chat_async.chat_async_facade import ChatAsyncFacadeService
                ...
                "text/event-stream": {
                    "examples": {
                        "streaming_response": {
                            ...
                            "value": (
                                "event: message_start\n"
                                'data: {"type":"message_start","message":{"id":"msg_12345","type":"message","role":"assistant","content":[],"model":"repomind","usage":{}}}\n\n'
