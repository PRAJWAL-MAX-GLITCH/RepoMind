...
from repomind.api.server.primitives.semantic_search_service import SemanticSearchService
...
class SearchResponse(BaseModel):
    ...
    model: Literal["repomind"] = Field(
        default="repomind", description="Model identifier used for chunk retrieval"
    )
