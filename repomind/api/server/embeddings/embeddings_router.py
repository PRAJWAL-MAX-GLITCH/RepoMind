...
from repomind.api.server.embeddings.embeddings_service import (
    Embedding,
    EmbeddingsService,
)
...
class EmbeddingsResponse(BaseModel):
    ...
    model: Literal["repomind"] = Field(
        default="repomind", description="The model used to generate embeddings"
    )
...
def embeddings_generation(request: Request, body: EmbeddingsBody) -> EmbeddingsResponse:
    ...
    * All embeddings are generated as query vectors. If the embeddings have two modes
    ...
    return EmbeddingsResponse(object="list", model="repomind", data=embeddings)
