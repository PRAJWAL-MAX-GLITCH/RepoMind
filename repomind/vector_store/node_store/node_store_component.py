...
def _postgres_index_store(settings: Settings, collection: str) -> BaseIndexStore:
    try:
        ...
        from repomind.vector_store.node_store.patched_postgres_kv_store import (  # type: ignore
    ...
    from repomind.data.postgres.postgres_client import LazyPostgresFactory
