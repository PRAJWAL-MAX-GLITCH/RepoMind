...
from repomind.vector_store.vector_store.factory import VectorStoreFactory
...
class QdrantVectorStoreFactory(VectorStoreFactory):
    ...
    def _build_client(self) -> Any:
        try:
            from repomind.vector_store.vector_store.qdrant_client_builder import (
                QdrantClientBuilder,
            )
    ...
    def vector_store(self, collection: str) -> BasePydanticVectorStore:
        try:
            ...
            from repomind.vector_store.vector_store.patched_qdrant_store import (
