...
from repomind.constants import REPOMIND_HOME

os.environ["REPOMIND_HOME"] = str(REPOMIND_HOME)

# Set to 'DEBUG' to have extensive logging turned on, even for libraries
ROOT_LOG_LEVEL = os.environ.get("REPOMIND_LOG_LEVEL", "INFO").upper()
...
if "TIKTOKEN_CACHE_DIR" not in os.environ:
    os.environ["TIKTOKEN_CACHE_DIR"] = str(REPOMIND_HOME / "tiktoken_cache")
