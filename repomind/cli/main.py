...
from repomind.cli.commands.run import run_command
from repomind.cli.commands.serve import serve_command

try:
    import celery as _celery  # noqa: F401

    from repomind.cli.commands.worker import worker_command
...
app = typer.Typer(
    name="repomind",
    help="RepoMind server CLI — manage the server, workers, and connected apps.",
...
def help_command(
    ...
    if command:
        sys.argv = ["repomind", command, "--help"]
