...
from repomind.chat.input_models import MessageInput, ToolSpecBody
from repomind.rag.chunk.models import Chunk
from repomind.rag.engines.citations.utils import process_history_citations
...
def test_tool_result_with_multiple_content_blocks() -> None:
    ...
    from repomind.events.models import SourceBlock
