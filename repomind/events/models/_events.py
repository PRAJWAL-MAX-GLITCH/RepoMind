...
from repomind.events.models._base import BaseContentBlock, StandardContentProtocol
from repomind.events.models._deltas import ContentBlockDeltaType
from repomind.events.models._errors import FatalError
from repomind.events.models._message import Message, MessageOutputDelta, Usage
from repomind.events.models._tool_result_blocks import ContentBlockType
...
class RawContentBlockStartEvent(BaseContentBlock, StandardContentProtocol):
    ...
    def from_text(
        ...
        from repomind.events.models._content_blocks import TextBlock
