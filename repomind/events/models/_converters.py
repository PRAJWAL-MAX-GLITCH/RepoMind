...
from repomind.rag.chunk.models import Website
from repomind.events.models._base import BaseContentBlock
...
def is_mcp_content_block(tool_output: Any) -> bool:
    return False

def convert_mcp_blocks_to_llama_index(tool_output: Any) -> Any:
    return None

def is_mcp_tool_result(tool_output: Any) -> bool:
    return False

def get_mcp_tool_result_content(tool_output: Any) -> Any:
    return None
