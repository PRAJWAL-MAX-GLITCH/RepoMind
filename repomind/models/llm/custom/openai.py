...
from repomind.models.llm.custom.structured_mixin import StructuredChatMixin
...
from repomind.events.models import StopReasonEnum
...
class PatchedOpenAILLM(StructuredChatMixin, OpenAIBase):  # type: ignore[misc]
    ...
    def _build_openai_response_format(
        ...
        from repomind.models.llm.custom.base import StructuredOutputsParams
    ...
    def _get_model_kwargs(self, **kwargs: Any) -> dict[str, Any]:
        from repomind.models.llm.custom.base import SamplingParameters
