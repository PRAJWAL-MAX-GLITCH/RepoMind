...
from repomind.models.llm.prompt_helper import get_tokenizer
from repomind.models.model_discovery.client import positive_int
from repomind.models.model_discovery.models import ModelKind
from repomind.models.model_discovery.service import discover_model_infos

if TYPE_CHECKING:
    from repomind.chat.input_models import ModelInfoOutput
...
def _model_info_to_config(
    ...
    from repomind.core.settings.settings import LLMModelConfig, SamplingParams
