...
from repomind.models.llm.tokenizers.models.auto_discovery import (
    auto_discover_model,
)
...
def _build_mistral_tokenizer(**kwargs: Any) -> TokenizerBase:
    from repomind.models.llm.tokenizers.mistral import MistralTokenizer
...
def _build_tiktoken_tokenizer(**kwargs: Any) -> TokenizerBase:
    from repomind.models.llm.tokenizers.tiktoken import TikTokenTokenizer

    return TikTokenTokenizer.from_pretrained(**kwargs)


def _build_estimator_tokenizer(**kwargs: Any) -> TokenizerBase:
    from repomind.models.llm.tokenizers.estimator import EstimatorTokenizer

    return EstimatorTokenizer.from_pretrained(**kwargs)


def _build_remote_tokenizer(**kwargs: Any) -> TokenizerBase:
    from repomind.models.llm.tokenizers.remote import RemoteTokenizeTokenizer
...
def _build_huggingface_tokenizer(**kwargs: Any) -> TokenizerBase:
    from repomind.models.llm.tokenizers.huggingface import HuggingFaceTokenizer
