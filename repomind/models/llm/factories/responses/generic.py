...
class OpenAIResponsesLLMLoader:
    ...
    def _load_patched_openai_responses() -> type[Any]:
        try:
            from repomind.models.llm.custom.openairesponses import (
...
class OpenAIGenericResponsesFactory(LLMFactory):
    ...
    def _create_llm(
        ...
        if is_openai_api_base(self.openai_settings.api_base):
            from repomind.models.llm.factories.responses.openai import (
        ...
        from repomind.models.llm.factories.responses.openailike import (
