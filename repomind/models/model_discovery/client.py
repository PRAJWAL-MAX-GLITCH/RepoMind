...
from repomind.models.model_discovery.models import UnclassifiedModel

if TYPE_CHECKING:
    from repomind.chat.input_models import ModelCapabilitiesOutput, ModelInfoOutput
...
def _parse_capabilities(value: Any) -> ModelCapabilitiesOutput | None:
    ...
    from repomind.chat.input_models import ModelCapabilitiesOutput
